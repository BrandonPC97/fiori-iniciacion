		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#pruebabkpcinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pruebabkpcinvoices-display": {
								"semanticObject": "pruebabkpcinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pruebabkpc.invoices",
									"url": sap.ui.require.toUrl("pruebabkpc/invoices")
								}
							}
						}
					}
